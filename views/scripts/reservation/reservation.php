		...
		<form role="form" id="bookingform" novalidate="novalidate">
			<div class="row">
				...
				<div class="col-md-6 no-display registergroup">
					<div class="panel panel-white">
						<div class="panel-heading">
							<h4 class="panel-title"><span class="btn btn-sm btn-transparent-grey backselectbutton" id="backselectbutton"><i class="fa fa-angle-double-left"> </i></span> <?php echo $this->translate('TXT_REGISTRATION_PANEL');?></h4>
						</div>
						<div class="panel-body">
