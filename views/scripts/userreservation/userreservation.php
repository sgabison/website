...
<!--					<a class="btn btn-social btn-primary btn-block" data-target=".bs-example-modal-basic" data-toggle="modal" id="mapmodal" ><i class="fa fa-map-marker"></i> <?php echo $this->translate('TXT_CHECK_LOCATION');?></a>-->
	...
	<div class="no-display">
		<h1>MENTIONS LEGALES ET CONDITIONS GENERALES D'UTILISATION DES SERVICES PROPOSES PAR <b>RESAEXPRESS</b></h1>
			...
			<h2>ACCEPTATION DES CONDITIONS GENERALES</h2>
			...
			<h2>OUVERTURE D'UN COMPTE - IDENTIFICATION - PREUVE<br>ECHANGE D'INFORMATIONS</h2>
			...
			<h2>LIMITATIONS DE RESPONSABILITE</h2>
			...
			<h2>SANCTION DES MANQUEMENTS CONTRACTUELS</h2>
