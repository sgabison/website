...
<!--
							<div class="col-md-12">
								<h4>
									...
									<select name="locationid" id="locationid" disabled>
										<?php foreach($this->locations as $loc){ ?>
										<option value="<?php echo $loc->getId();?>" <?php if( $loc->getId()==$this->locationid ){echo "selected";}?>><?php echo $loc->getName();?></option>
										<?php } ?>
									</select>
								</h4>
							</div>
							<div class="col-md-12">
								<h4>
									<small>Serving</small>
									<select name="servingid" id="servingid" disabled>
										<?php foreach($this->servings as $serv){ ?>
										<option value="<?php echo $serv->getId();?>" <?php if( $serv->getId()==$this->servingid ){echo "selected";}?>><?php echo $serv->getTitle();?></option>
										<?php } ?>
									</select>
								</h4>
							</div>
