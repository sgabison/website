					...
					<? include( PIMCORE_LAYOUTS_DIRECTORY ."/inc_breadcrumb.php") ; ?>
							...
							<div class="col-md-12">
								...
								<div class="panel panel-white">
									<div class="panel-heading">
										...
										<div class="col-md-3">
											<button class="btn btn-transparent-grey">Fetch!
											</button>
										</div>
									</div>
								</div>
						...
						<div class="row">
							<div class="col-md-12">
								...
								<div class="panel panel-white">
									<div class="panel-heading">
										<h4 class="panel-title"><?= $this->translate("RESERVATION_LIST")?> <span class="text-bold"><?= $this->translate("Role")?></span></h4>
									...
									<div class="panel-body">
										<div class="row" id="example-dids">
											<a href="/fr/booking/reservation" class="demo ajax btn btn-blue">Create New Reservation</a>
