									...
									<ul class="nav nav-tabs tab-padding tab-space-3 tab-blue" id="myTab4">
										...
										<li>
											<a data-toggle="tab" href="#panel_edit_account">
												<?php echo $this->t("TXT_MY_ACCOUNT")?>
											</a>
										</li>
										<li>
											<a data-toggle="tab" href="#panel_projects">
												<?php echo $this->t("TXT_MY_RESERVATIONS")?>
											</a>
										</li>
									</ul>
										...
										<div id="panel_overview" class="tab-pane fade in active">
											<div class="row">
												<div class="col-sm-5 col-md-4">
													<div class="user-left">
														<div class="center">
															<h4><?= $this->guest->getFullname() ?> </h4>
															<div class="fileupload fileupload-new" data-provides="fileupload">
																<div class="user-image">
																	<div class="fileupload-new thumbnail">													
																	<img src="<? if ( $this->guest->getAvatar() ) { echo $this->guest->getAvatar()->getThumbnail('avatar') ;} else { ?><?= PIMCORE_WEBSITE_LAYOUTS?>/assets/images/anonymous.jpg<? } ?>" alt="image"/></td>
														...
														<table class="table table-condensed table-hover">
															<thead>
																<tr>
																	<th colspan="3"><?php echo $this->t("TXT_MY_CONTACT")?></th>
																</tr>
															</thead>
															<tbody>
																<tr>
