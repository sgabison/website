	...
	<body class="single-page">
		...
		<script src="<?= PIMCORE_WEBSITE_LAYOUTS?>/assets/js/setupform-validation.js"></script>
		<script src="<?= PIMCORE_WEBSITE_LAYOUTS?>/assets/js/timepicker-form-elements.js"></script>
