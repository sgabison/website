						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<input class="contributor-form-method hide" type="text">
							...
							<div class="col-md-6">
								...
								<div class="form-group">
									<div class="fileupload fileupload-new contributor-avatar" data-provides="fileupload">
										<div class="fileupload-new thumbnail"><img src="<?= PIMCORE_WEBSITE_LAYOUTS?>/assets/images/anonymous.jpg" alt="" width="50" height="50"/>
										</div>
