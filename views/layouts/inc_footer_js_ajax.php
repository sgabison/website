			...
			var runTranslate=function(){
				...
				$.getJSON('/data/default/trad', function(data){ 
					var option={    resStore: data.store, lng: data.lng , 
									...
									localStorageExpirationTime: 864000  // in ms, default 1 week
								};
					i18n.init(option);
		...
		<script src="<?= PIMCORE_WEBSITE_LAYOUTS?>/assets/plugins/ckeditor/ckeditor.js"></script>
		<script src="<?= PIMCORE_WEBSITE_LAYOUTS?>/assets/plugins/ckeditor/adapters/jquery.js"></script>
		...
		<script src="<?= PIMCORE_WEBSITE_LAYOUTS?>/assets/plugins/fullcalendar/fullcalendar/lang-all.js"></script>		
