...
$fields=array('id','name','description','address','zip','city','tel','email','fax','maxSeats','maxTables','resaUnit','maxResaPerUnit','maxResaSeats','mealduration','latlngresult', 'url', 'minutesBeforeService');
